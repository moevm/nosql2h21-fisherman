    ...
    return (
            <Container fluid="md">
                <Row className={'mt-2'}>
                    ...
                    <Col>
                        <Button className={'mx-2 btn btn-warning'}>Вход</Button>
                        <Button className={' btn btn-warning'}>Регистрация</Button>
                    </Col>
                </Row>
                <Row className={'p-2'}>
                    <FormControl
                ...
                <Row className={'p-3'}>
                    ...
                    <Col className={'d-flex'}>
                        ...
                        <Button  className={' btn-sm'}>Возрастание цены</Button>
                        <Button  className={'mx-2 btn-sm'}>Возрастание цены</Button>
                        <Button className={'btn-sm'}>От А до Я</Button>
                    </Col> 
                </Row>
                <Row className={'p-3'}>
                    <Col>
